  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col items-center">
      <div
        ...
        className="flex w-full rounded-full border border-line bg-surface-muted p-1 shadow-[var(--shadow-card)]"
      >
        {TABS.map(({ id, label }) => {
      ...
      <Button
        size="lg"
        asChild
        className="mt-6 h-14 min-h-14 w-full rounded-full border border-ink bg-cta px-8 text-base text-cta-foreground hover:bg-cta-hover active:bg-cta-hover"
      >
        <Link
          href={REGISTER_URL}
          target="_blank"
